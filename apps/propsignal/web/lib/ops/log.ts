 ...
 * which the /ops dashboard consumes. Copied from apps/docai/web/lib/ops/log.ts
 * (local wrapper pattern — keeps the scaffold free of workspace deps).
 *
...
export type OpsSource = 'propsignal'
...
export async function logEvent(input: LogEventInput): Promise<void> {
  try {
    ...
    console.warn('[ops-log/propsignal]', err instanceof Error ? err.message : err)
  }
}
