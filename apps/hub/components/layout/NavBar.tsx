    ...
    <>
      <nav style={navStyle} className="no-print">
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          {/* Daybreak / Ultraviolet toggle — flips data-bl-theme-v2 between
              the two LIGHT hub themes (warm cream vs pale lavender). Writes
              localStorage so the next navigation respects the choice over
              the per-route page-default. */}
          <PageThemeToggle />
          <ThemeToggle size={32} />
          <Link
            href="/risk-engine"
