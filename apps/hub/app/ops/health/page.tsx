...
export const metadata: Metadata = {
  title: 'Ops Health — BizLegal AI',
  description: 'Subdomain reachability + HMAC chain audit. Internal use.',
...
export default function OpsHealthPage({ searchParams }: PageProps) {
  ...
  return <OpsHealthClient cronSecretConfigured={Boolean(process.env.CRON_SECRET)} />
}
