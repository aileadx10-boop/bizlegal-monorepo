...
const TARGETS: ReadonlyArray<SubProbe> = [
  ...
  { name: 'casepage',  url: 'https://casepage.bizlegal-ai.com/api/digest',   source: 'casepage' },
  { name: 'sincefiled', url: 'https://sincefiled.bizlegal-ai.com/api/digest', source: 'sincefiled' },
  { name: 'leaseparse', url: 'https://leaseparse.bizlegal-ai.com/api/digest', source: 'leaseparse' },
  { name: 'deal44',    url: 'https://deal44.bizlegal-ai.com/api/digest',     source: 'deal44' },
