...
export default function AcceptableUsePage() {
  return (
    <LegalPage
      ...
      intro="BRAI is for lawful investigative, compliance, litigation-support, and asset-recovery work. The list below is illustrative, not exhaustive."
    >
      <section>
