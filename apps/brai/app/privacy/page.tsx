...
export default function PrivacyPage() {
  return (
    <LegalPage
      title="Privacy."
      intro="What data BRAI collects, how we use it, and how long we keep it. The canonical privacy policy for the BizLegal AI family lives at bizlegal-ai.com/privacy; this page mirrors the product-specific data flows for BRAI."
    >
      <section>
        <h2 className="lp-h2">Data we collect.</h2>
        <p>
          Wallet addresses, venture identifiers, and chain/jurisdiction parameters you submit for analysis;
        ...
        <p>
          BRAI operates across multiple jurisdictions. Submissions may be processed in the
