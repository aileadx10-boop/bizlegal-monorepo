...
**Status (2026-08-16): SCAFFOLD.** Canonical plan: `decisions/BENCH-LEGAL-AI-QUALITY-2026-08-16.md`. Moses gates: benchmark + legal review, migration apply, Vercel project + CNAME, self-benchmark run, test purchase.
