 ...
 *
 * When a buyer pays for product=sellerradar via bizlegal-ai.com/checkout, the
 * hub webhook's sellerradar-grant helper POSTs here (HMAC-SHA256 over the raw
 * body with BIZLEGAL_INBOUND_SECRET, same protocol as /api/inbound-lead).
 * The apex checkout knows the buyer's email + tier but not their catalog, so
