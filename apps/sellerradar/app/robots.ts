 ...
 *
 * SellerRadar uses curated fee fixtures (it never scrapes gated content), and
 * in turn welcomes the answer engines' crawlers.
 */

// App-specific private paths. '/api/' and '/_next/' come from the shared
// DEFAULT_DISALLOW and are not repeated.
const PRIVATE: string[] = ['/report/', '/analyze', '/success']
