  ...
  if (variant === "micro") {
    return (
      <div
        ...
        style={{
          padding: "20px 24px",
          borderTop: "1px solid var(--outline-var, #1f2937)",
          background: "var(--bg-low, #0b0f17)",
          fontFamily: "var(--font-body, ui-sans-serif)",
          fontSize: "12px",
          lineHeight: 1.5,
          color: "var(--on-surface-var, #94a3b8)",
        }}
      >
        ...
        >
          ...
          ·{" "}
          <Link href="/acceptable-use" style={{ color: "inherit", textDecoration: "underline" }}>
            Acceptable Use
          </Link>{" "}
          ·{" "}
  ...
  return (
    <section
      ...
      style={{
        ...
        background: "var(--bg-low, #0b0f17)",
        borderTop: "1px solid var(--outline-var, #1f2937)",
        borderBottom: "1px solid var(--outline-var, #1f2937)",
        marginTop: "64px",
      }}
    >
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ display: "flex", gap: 16, fontSize: 12 }}>
            <Link href="/disclaimer" style={{ color: "var(--on-surface-var, #94a3b8)" }}>
              Disclaimer →
            </Link>
            <Link href="/acceptable-use" style={{ color: "var(--on-surface-var, #94a3b8)" }}>
              Acceptable Use →
            </Link>
            <Link href="/terms" style={{ color: "var(--on-surface-var, #94a3b8)" }}>
              Terms →
            </Link>
          </div>
        </div>
