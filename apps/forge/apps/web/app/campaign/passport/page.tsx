        ...
        <div className="max-w-3xl mx-auto px-6 py-16">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: 'How is this different from a law firm?', a: 'A law firm charges $500-$1,500/hour to scope what you need. Forge analyzes your specific profile against each market\'s requirements, sends every brief through practitioner review, and delivers a structured roadmap in 24 hours.' },
