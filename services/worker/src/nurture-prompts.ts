...
export const VERTICAL_CONTEXTS: Record<NurtureVertical, VerticalContext> = {
  ...
  leaseparse: {
    product_name: "LeaseParse",
    product_url: "https://leaseparse.bizlegal-ai.com",
    regulator_focus: "commercial-lease critical dates (options, CAM, commencement) — not legal advice",
    pain_point: "option windows and rent-commencement dates sit in the PDF until someone misses them",
    deliverable: "one text-layer lease abstract with extracted dates and a risk score, delivered by email",
    decision_pressure: "an un-abstracted lease is a silent clock; the option you did not diary is the one that expires",
    comparison_alts: "Paralegal abstract ($200-400/lease, days), full CAM-recon engines (out of scope here), reading the PDF again yourself",
  },
  casepage: {
    product_name: "CasePage",
    product_url: "https://casepage.bizlegal-ai.com",
    regulator_focus: "client communication / matter-status transparency (ethics rules on keeping clients informed)",
    pain_point: "clients call for status because they have no page that shows where the matter actually stands",
    deliverable: "a client-facing matter-status page with milestones, a document checklist, and the next-hearing countdown",
    decision_pressure: "every unanswered 'where is my case' email is a retention risk; a live page answers it without a call",
    comparison_alts: "Clio/MyCase portals (heavy, billed per seat), a shared Google Doc (no access control), doing nothing (the phone keeps ringing)",
  },
  sincefiled: {
    product_name: "SinceFiled",
    product_url: "https://sincefiled.bizlegal-ai.com",
    regulator_focus: "firm internal clocks — trust recon, CLE, renewals, filings (estimates, not jurisdiction lookup)",
    pain_point: "the last trust recon or CLE hour has no visible 'days since', so the next one is late before anyone notices",
    deliverable: "a days-since tracker with a predicted-due estimate and optional PDF packs — verify against your jurisdiction",
    decision_pressure: "missed trust recon and CLE are the quiet malpractice-adjacent failures; a streak counter makes the gap visible today",
    comparison_alts: "A spreadsheet someone stops updating, practice-management reminders buried in a matter, a calendar invite that expires",
  },
  brainx: {
    product_name: "BrainX Opportunity Radar",
    product_url: "https://brainx.bizlegal-ai.com",
    regulator_focus: "real-estate / legal-practice / AI-fintech compliance opportunities, evidence-gated",
    pain_point: "weekly opportunity noise has no scored, sourced shortlist you can act on without another research cycle",
    deliverable: "a weekly operator-run radar: scored opportunities, ≥3 verified public sources, optional BUILD THIS brief",
    decision_pressure: "windows close on other people's calendars; a radar you read on Monday is usable this week, not next quarter",
    comparison_alts: "Generic newsletters (no score, no evidence gate), a $5k/mo research retainer, scrolling Twitter for 'ideas'",
  },
  deal44: {
    product_name: "DEAL44",
    product_url: "https://deal44.bizlegal-ai.com",
    regulator_focus: "Israeli residential closing checklists (Tabu / ILA / management company) — Hebrew and RTL first",
    pain_point: "each party in a sale has a different private to-do list and the statutory clocks do not wait for email threads",
    deliverable: "a multi-party deal room: hashed-token access, per-party tasks, digest alerts before dates pass",
    decision_pressure: "30-day declarations and registration steps run on calendar days; a missed one is not a UX bug",
    comparison_alts: "WhatsApp groups (no provenance), a broker spreadsheet (one owner, no party isolation), a US-week engine that treats Friday as a working day",
  },
  realestate: {
